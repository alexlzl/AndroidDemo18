...
var GameRoot = s.rootObject().createChild();
GameRoot.active = true;
GameRoot.transform.position = { x: 9999999, y:999999, z: 9999999};
var stateStr = "Found";
...
var JsNativeBinding = function (sendMessage, pushResponseHandler) {
    return {
        ...
        ArSenceState: function (type) {
           if (type == undefined) {//字符串："aim1"(加载),"aim2"(打开)
           type = "";
           }
           sendMessage("request:JsNativeBinding.ArSenceState", [type]);
        }
    };
};
...
var NativeJsBinding = function () {
    ...
    functions["request:NativeJsBinding.changeCameraDeviceTypeBack"] = function (receiver, params, sendMessage) {
                receiver.changeCameraDeviceTypeBack();
    };
    functions["request:NativeJsBinding.hideAR"] = function (receiver, params, sendMessage) {
        receiver.hideAR();
    };
    functions["request:NativeJsBinding.callflashlight"] = function (receiver, params, sendMessage) {
                      receiver.callflashlight();
	};
    functions["request:NativeJsBinding.closeCamera"] = function (receiver, params, sendMessage) {
                              receiver.closeCamera();
    };
    ...
    functions["request:NativeJsBinding.SetARActive"] = function (receiver, params, sendMessage) {
            receiver.SetARActive();
    };//再玩一次
	functions["request:NativeJsBinding.InitializeAR"] = function (receiver, params, sendMessage) {
            receiver.InitializeAR();
    };//单个蒲公英显示
	functions["request:NativeJsBinding.InitializeDandelion"] = function (receiver, params, sendMessage) {
            receiver.InitializeDandelion(params[0]);
    };//单个蒲公英吹散
	functions["request:NativeJsBinding.AinOneDandelion"] = function (receiver, params, sendMessage) {
            receiver.AinOneDandelion();
    };//红包加载动画
	functions["request:NativeJsBinding.AinTwoDandelion"] = function (receiver, params, sendMessage) {
            receiver.AinTwoDandelion();
    };//红包打开动画
	functions["request:NativeJsBinding.AinThreeDandelion"] = function (receiver, params, sendMessage) {
            receiver.AinThreeDandelion();
    };//关闭AR内容
	functions["request:NativeJsBinding.AinOverDandelion"] = function (receiver, params, sendMessage) {
            receiver.AinOverDandelion();
    };
    functions["request:NativeJsBinding.SetGameRoot"] = function (receiver, params, sendMessage) {
                    receiver.SetGameRoot();
    };
    return {
        /**
         * @param name {string}
...
var nativeReceiver = {
    ...
    changeCameraDeviceTypeBack: function () {
          arcamera.close();
          com_cameraDevice.deviceType = "back";
          arcamera.open();
          console.log("[Js] request:NativeJsBinding.changeCameraDeviceTypeBack : default");
    },
    closeCamera: function () {
            sceneState.closeCamera();
            console.log("[Js] request:NativeJsBinding.closeCamera : default");
        },
    hideAR: function () {
        sceneState.hideAR();
	...
	callflashlight: function () {
	    sceneState.callflashlight();
        console.log("[Js] request:NativeJsBinding.GestureEnd : default " );
    },
    SetARActive: function () {
            sceneState.SetARActive();
            console.log("[Js] request:NativeJsBinding.SetARActive : default");
    },
	InitializeDandelion: function (type) {
            sceneState.InitializeDandelion(type);
            console.log("[Js] request:NativeJsBinding.SetARActive : default");
    },
	AinOneDandelion: function () {
            sceneState.AinOneDandelion();
            console.log("[Js] request:NativeJsBinding.SetARActive : default");
    },
	AinTwoDandelion: function () {
            sceneState.AinTwoDandelion();
            console.log("[Js] request:NativeJsBinding.SetARActive : default");
    },
	AinThreeDandelion: function () {
            sceneState.AinThreeDandelion();
            console.log("[Js] request:NativeJsBinding.SetARActive : default");
    },
	AinOverDandelion: function () {
            sceneState.AinOverDandelion();
            console.log("[Js] request:NativeJsBinding.SetARActive : default");
    },
	InitializeAR: function () {
            sceneState.InitializeAR();
            console.log("[Js] request:NativeJsBinding.SetARActive : default");
    },
    SetGameRoot: function () {
            sceneState.SetGameRoot();
            console.log("[Js] request:NativeJsBinding.SetGameRoot : default");
    }
};
...
var sceneState = {
    ...
    closeCamera: function () {
                if(!com_cameraDevice.isOpened)
               	   {
               			com_cameraDevice.isOpened = true;
               	   }else{
               			com_cameraDevice.isOpened = false;
               	   }
    },
    showARWithTrack: function () {
	...
	callflashlight: function () {
       if(!com_cameraDevice.flashTorchMode)
	   {
			com_cameraDevice.flashTorchMode = true;
	   }else{
			com_cameraDevice.flashTorchMode = false;
	   }
    },
	SetARActive:function () {
	   GameRoot.transform.position = arcamera.transform.position;
       com_imagetracker.isRunning = false;
	   stateStr ="Found";
	   GameRoot.transform.position = { x: 0, y:0, z: 99999};
	   arcamera.transform.position = { x: 0, y:0, z: 0};
	   GameRoot.active = true;
	   JsNative.ArSenceState("ActiveOver");
    },
    SetGameRoot:function () {
        	  GameRoot.transform.position = { x: 0, y:0, z: 0};
        	  JsNative.ArSenceState("GameRootOver");
...
sceneManager.imuTarget["singleMoveListener"] = function (_x, _y) {
    ...
    if (sceneManager.imuTarget["usefornt"]) {
